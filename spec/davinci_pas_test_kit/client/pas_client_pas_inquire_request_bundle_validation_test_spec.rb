RSpec.describe DaVinciPASTestKit::DaVinciPASV201::ClientPasInquireRequestBundleValidationTest, :request do # rubocop:disable RSpec/SpecFilePathFormat
  ...
  let(:approval_test) do
    Class.new(DaVinciPASTestKit::DaVinciPASV201::ClientPasInquireRequestBundleValidationTest) do
