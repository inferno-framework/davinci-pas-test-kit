...
module DaVinciPASTestKit
  module DaVinciPASV220
    class PASServerDenialUseCaseGroup < Inferno::TestGroup
      id :pas_server_v220_denial_use_case
      ...
      group do
        ...
        test from: :pas_server_request_bundle_validation_test do
          id :pas_server_v220_pas_request_bundle_validation_test_denial
        ...
        test from: :pas_claim_submit_operation_test do
          id :pas_v220_claim_submit_operation_test_denial
          config(
            inputs: {
        ...
        test from: :pas_server_response_bundle_validation_test do
          id :pas_server_v220_pas_response_bundle_validation_test_denial
        ...
        test from: :prior_auth_claim_response_decision_validation do
          id :pas_server_v220_decision_validation_test_denial
