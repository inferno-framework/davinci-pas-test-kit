...
require_relative '../../v2.2.0/pas_error_group'
require_relative '../../v2.2.0/pas_server_subscription_setup'
...
module DaVinciPASTestKit
  module DaVinciPASV220
    class ServerSuite < Inferno::TestSuite
      id :davinci_pas_server_suite_v220
      title 'Da Vinci PAS Server Suite v2.2.0'
      description %(
      ...
      group from: :pas_server_v220_subscription_setup
      ...
      group 'Demonstrate Workflow Support' do
        ...
        group from: :pas_server_v220_approval_use_case
        group from: :pas_server_v220_denial_use_case
        group from: :pas_server_v220_pended_use_case
      end
      group from: :pas_server_v220_must_support
      group from: :pas_v220_error_group
    end
  end
end
