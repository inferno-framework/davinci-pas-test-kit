...
require_relative '../../v2.2.0/must_support/pas_server_must_support_request_profiles_test'
...
module DaVinciPASTestKit
  module DaVinciPASV220
    class PASServerMustSupportGroup < Inferno::TestGroup
      id :pas_server_v220_must_support
      ...
      group do
        ...
        group do
          ...
          test from: :pas_claim_submit_operation_test do
            id :pas_v220_claim_submit_operation_test_must_support
            config(
              inputs: {
          ...
          test from: :pas_server_response_bundle_validation_test do
            id :pas_server_v220_submit_response_bundle_validation_test_must_support
        ...
        group do
          ...
          test from: :pas_server_v220_submit_request_must_support_claim_update
          test from: :pas_server_v220_submit_request_must_support_coverage
          test from: :pas_server_v220_submit_request_must_support_encounter
          test from: :pas_server_v220_submit_request_must_support_insurer
          test from: :pas_server_v220_submit_request_must_support_requestor
          test from: :pas_server_v220_submit_request_must_support_beneficiary
          test from: :pas_server_v220_submit_request_must_support_subscriber
          test from: :pas_server_v220_submit_request_must_support_practitioner
          test from: :pas_server_v220_submit_request_must_support_practitioner_role
        end

        group do
          title '$submit Response Must Support'
          test from: :pas_server_v220_submit_response_must_support_pas_response_bundle
          test from: :pas_server_v220_submit_response_must_support_claimresponse
          test from: :pas_server_v220_submit_response_must_support_communication_request
          test from: :pas_server_v220_submit_response_must_support_insurer
          test from: :pas_server_v220_submit_response_must_support_requestor
          test from: :pas_server_v220_submit_response_must_support_beneficiary
          test from: :pas_server_v220_submit_response_must_support_practitioner
          test from: :pas_server_v220_submit_response_must_support_practitioner_role
          test from: :pas_server_v220_submit_response_must_support_task
        end
      end
      group do
        ...
        group do
          ...
          test from: :pas_claim_inquire_operation_test do
            id :pas_v220_claim_inquire_operation_test_must_support
            config(
              inputs: {
          ...
          test from: :pas_server_response_bundle_validation_test do
            id :pas_server_v220_inquire_response_bundle_validation_test_must_support
        ...
        group do
          ...
          test from: :pas_server_v220_inquire_request_must_support_coverage
          test from: :pas_server_v220_inquire_request_must_support_insurer
          test from: :pas_server_v220_inquire_request_must_support_requestor
          test from: :pas_server_v220_inquire_request_must_support_beneficiary
          test from: :pas_server_v220_inquire_request_must_support_subscriber
          test from: :pas_server_v220_inquire_request_must_support_practitioner
          test from: :pas_server_v220_inquire_request_must_support_practitioner_role
        end

        group do
          title '$inquire Response Must Support'
          test from: :pas_server_v220_inquire_response_must_support_pas_inquiry_response_bundle
          test from: :pas_server_v220_inquire_response_must_support_claiminquiryresponse
          test from: :pas_server_v220_inquire_response_must_support_insurer
          test from: :pas_server_v220_inquire_response_must_support_requestor
          test from: :pas_server_v220_inquire_response_must_support_beneficiary
          test from: :pas_server_v220_inquire_response_must_support_practitioner
          test from: :pas_server_v220_inquire_response_must_support_practitioner_role
          test from: :pas_server_v220_inquire_response_must_support_task
        end
      end
    end
  end
