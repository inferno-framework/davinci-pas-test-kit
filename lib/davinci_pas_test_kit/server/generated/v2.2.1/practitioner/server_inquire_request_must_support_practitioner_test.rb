...
module DaVinciPASTestKit
  module DaVinciPASV221
    class ServerInquireRequestMustSupportPractitionerTest < DaVinciPASTestKit::MustSupportTest
      id :pas_server_v221_inquire_request_must_support_practitioner
      title 'All must support elements for profile PAS Practitioner are observed on $inquire requests'
      description %(
