...
module DaVinciPASTestKit
  module DaVinciPASV221
    class ServerSubmitRequestMustSupportCoverageTest < DaVinciPASTestKit::MustSupportTest
      id :pas_server_v221_submit_request_must_support_coverage
      title 'All must support elements for profile PAS Coverage are observed on $submit requests'
      description %(
