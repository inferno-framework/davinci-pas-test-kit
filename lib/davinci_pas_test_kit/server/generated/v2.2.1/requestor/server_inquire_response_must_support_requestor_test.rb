...
module DaVinciPASTestKit
  module DaVinciPASV221
    class ServerInquireResponseMustSupportRequestorTest < DaVinciPASTestKit::MustSupportTest
      id :pas_server_v221_inquire_response_must_support_requestor
      title 'All must support elements for profile PAS Requestor Organization are observed on $inquire responses'
      description %(
