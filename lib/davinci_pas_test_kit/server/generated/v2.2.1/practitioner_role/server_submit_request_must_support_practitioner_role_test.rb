...
module DaVinciPASTestKit
  module DaVinciPASV221
    class ServerSubmitRequestMustSupportPractitionerRoleTest < DaVinciPASTestKit::MustSupportTest
      id :pas_server_v221_submit_request_must_support_practitioner_role
      title 'All must support elements for profile PAS PractitionerRole are observed on $submit requests'
      description %(
