...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ServerSubmitRequestClaimUpdateMustSupportTest < Inferno::Test
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, '..', '..', '..', '..', 'cross_suite', 'generated', 'v2.0.1', 'claim_update', 'metadata.yml'), aliases: true))
      end
