...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ServerSubmitResponseMustSupportBeneficiaryTest < DaVinciPASTestKit::MustSupportTest
      id :pas_server_v201_submit_response_must_support_beneficiary
      title 'All must support elements for profile PAS Beneficiary Patient are observed on $submit responses'
      description %(
