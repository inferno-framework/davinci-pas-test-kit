...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ServerSubmitRequestSubscriberMustSupportTest < Inferno::Test
      ...
      id :pas_server_submit_request_v201_subscriber_must_support_test
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, '..', '..', '..', '..', 'cross_suite', 'generated', 'v2.0.1', 'subscriber', 'metadata.yml'), aliases: true))
      end
