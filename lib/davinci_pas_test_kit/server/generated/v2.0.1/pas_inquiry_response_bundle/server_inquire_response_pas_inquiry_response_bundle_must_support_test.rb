...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ServerInquireResponsePasInquiryResponseBundleMustSupportTest < Inferno::Test
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, '..', '..', '..', '..', 'cross_suite', 'generated', 'v2.0.1', 'pas_inquiry_response_bundle', 'metadata.yml'), aliases: true))
      end
