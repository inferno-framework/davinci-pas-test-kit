...
module DaVinciPASTestKit
  module DaVinciPASV201
    class PasServerMustSupportRequestProfilesTest < DaVinciPASTestKit::MustSupportRequestTypeTest
      id :pas_server_v201_must_support_request_profiles
      title %(
      ...
      description %(
        ...
        * PAS Nutrition Order
        ...
        The test will look through the instances included in submissions for the following must
        support elements:
