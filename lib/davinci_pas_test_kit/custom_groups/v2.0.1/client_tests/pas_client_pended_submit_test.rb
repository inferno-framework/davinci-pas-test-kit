  ...
  module DaVinciPASV201
    class PASClientPendedSubmitTest < Inferno::Test
      ...
      run do
        ...
        unless user_inputted_response? :pended_json_response
          add_message('info', %(
        ...
        unless user_inputted_response? :inquire_json_response
          add_message('info', %(
            No inquiry response provided in input '#{input_title(:inquire_json_response)}'. Any responses to $inquire
