module DaVinciPASTestKit
  module ResponseGenerator
    ...
    # - reference to the submitted Claim (may not have control of created id)
    ...
    def update_tester_provided_notification(user_inputted_notification, generated_claim_response_uuid)
      ...
      if focus_part.blank?
        # echo bad notification without modification, other tests will catch problems
        user_inputted_notification
      else
