...
module DaVinciPASTestKit
  module DaVinciPASV221
    class ClientSubmitResponseMustSupportPractitionerTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v221_submit_response_must_support_practitioner
      title 'All must support elements for profile PAS Practitioner are observed on $submit responses'
      description %(
