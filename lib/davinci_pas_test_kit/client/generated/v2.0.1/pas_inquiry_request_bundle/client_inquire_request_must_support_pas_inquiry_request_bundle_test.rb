...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ClientInquireRequestMustSupportPasInquiryRequestBundleTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v201_inquire_request_must_support_pas_inquiry_request_bundle
      title 'All must support elements for profile PAS Inquiry Request Bundle are observed on $inquire requests'
      description %(
