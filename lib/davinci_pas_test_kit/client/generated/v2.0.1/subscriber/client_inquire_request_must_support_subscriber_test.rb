...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ClientInquireRequestMustSupportSubscriberTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v201_inquire_request_must_support_subscriber
      title 'All must support elements for profile PAS Subscriber Patient are observed on $inquire requests'
      description %(
