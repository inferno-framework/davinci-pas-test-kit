...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ClientInquireRequestMustSupportRequestorTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v201_inquire_request_must_support_requestor
      title 'All must support elements for profile PAS Requestor Organization are observed on $inquire requests'
      description %(
