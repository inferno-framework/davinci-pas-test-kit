...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ClientSubmitRequestMustSupportRequestorTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v201_submit_request_must_support_requestor
      title 'All must support elements for profile PAS Requestor Organization are observed on $submit requests'
      description %(
