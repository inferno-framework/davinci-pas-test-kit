...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ClientInquireRequestMustSupportInsurerTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v201_inquire_request_must_support_insurer
      title 'All must support elements for profile PAS Insurer Organization are observed on $inquire requests'
      description %(
