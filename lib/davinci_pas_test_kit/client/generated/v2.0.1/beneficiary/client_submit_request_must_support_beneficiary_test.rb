...
module DaVinciPASTestKit
  module DaVinciPASV201
    class ClientSubmitRequestMustSupportBeneficiaryTest < DaVinciPASTestKit::MustSupportTest
      id :pas_client_v201_submit_request_must_support_beneficiary
      title 'All must support elements for profile PAS Beneficiary Patient are observed on $submit requests'
      description %(
