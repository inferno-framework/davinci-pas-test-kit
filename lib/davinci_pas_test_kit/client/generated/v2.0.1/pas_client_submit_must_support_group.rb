require_relative '../../v2.0.1/workflows/pas_client_submit_gather_must_support_test'
...
module DaVinciPASTestKit
  module DaVinciPASV201
    class PASClientSubmitMustSupportGroup < Inferno::TestGroup
      ...
      test from: :pas_client_v201_submit_gather_must_support
      ...
      test from: :pas_client_v201_submit_request_must_support_coverage
      test from: :pas_client_v201_submit_request_must_support_encounter
      test from: :pas_client_v201_submit_request_must_support_insurer
      test from: :pas_client_v201_submit_request_must_support_requestor
      test from: :pas_client_v201_submit_request_must_support_beneficiary
      test from: :pas_client_v201_submit_request_must_support_subscriber
      test from: :pas_client_v201_submit_request_must_support_practitioner
      test from: :pas_client_v201_submit_request_must_support_practitioner_role
    end
  end
end
