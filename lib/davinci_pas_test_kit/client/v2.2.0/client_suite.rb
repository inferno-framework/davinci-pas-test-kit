...
module DaVinciPASTestKit
  module DaVinciPASV220
    class ClientSuite < Inferno::TestSuite
      id :davinci_pas_client_suite_v220
      title 'Da Vinci PAS Client Suite v2.2.0'
      description %(
      ...
      group from: :pas_client_v220_workflows, id: :pas_client_v220_workflows_smart do
        required_suite_options client_type: PASClientOptions::SMART_BACKEND_SERVICES_CONFIDENTIAL_ASYMMETRIC
        PASClientOptions.recursive_remove_input(self, :session_url_path)
        config(inputs: { client_id: { optional: false } })
      end
      group from: :pas_client_v220_must_support, id: :pas_client_v220_must_support_smart do
        required_suite_options client_type: PASClientOptions::SMART_BACKEND_SERVICES_CONFIDENTIAL_ASYMMETRIC
        PASClientOptions.recursive_remove_input(self, :session_url_path)
        config(inputs: { client_id: { optional: false } })
      end
      ...
      group from: :pas_client_v220_subscription_setup, id: :pas_client_v220_subscription_setup_udap do
        required_suite_options client_type: PASClientOptions::UDAP_CLIENT_CREDENTIALS
        PASClientOptions.recursive_remove_input(self, :session_url_path)
        config(inputs: { client_id: { optional: false } })
      end
      group from: :pas_client_v220_workflows, id: :pas_client_v220_workflows_udap do
        required_suite_options client_type: PASClientOptions::UDAP_CLIENT_CREDENTIALS
        PASClientOptions.recursive_remove_input(self, :session_url_path)
        config(inputs: { client_id: { optional: false } })
      end
      group from: :pas_client_v220_must_support, id: :pas_client_v220_must_support_udap do
        required_suite_options client_type: PASClientOptions::UDAP_CLIENT_CREDENTIALS
        PASClientOptions.recursive_remove_input(self, :session_url_path)
        config(inputs: { client_id: { optional: false } })
      end
      ...
      group from: :pas_client_v220_subscription_setup, id: :pas_client_v220_subscription_setup_no_auth do
      ...
      group from: :pas_client_v220_workflows, id: :pas_client_v220_workflows_no_auth do
        required_suite_options client_type: PASClientOptions::OTHER_AUTH
        PASClientOptions.recursive_remove_input(self, :client_id)
        config(inputs: { session_url_path: { optional: false } })
      end
      group from: :pas_client_v220_must_support, id: :pas_client_v220_must_support_no_auth do
        required_suite_options client_type: PASClientOptions::OTHER_AUTH
        PASClientOptions.recursive_remove_input(self, :client_id)
        config(inputs: { session_url_path: { optional: false } })
      end

      group from: :pas_client_v220_auth_smart,
            required_suite_options: {
              client_type: PASClientOptions::SMART_BACKEND_SERVICES_CONFIDENTIAL_ASYMMETRIC
            }
      group from: :pas_client_v220_auth_udap,
            required_suite_options: {
