require_relative '../pas_client_denial_submit_test'
...
module DaVinciPASTestKit
  module DaVinciPASV220
    class PASClientDenialGroup < Inferno::TestGroup
      ...
      id :pas_client_v220_denial_group
      ...
      test from: :pas_client_denial_submit_test
      test from: :pas_client_v220_request_bundle_validation_test,
           config: { options: { workflow_tag: DENIAL_WORKFLOW_TAG } }
      test from: :pas_client_v220_response_bundle_validation_test,
           config: { options: { workflow_tag: DENIAL_WORKFLOW_TAG } }
