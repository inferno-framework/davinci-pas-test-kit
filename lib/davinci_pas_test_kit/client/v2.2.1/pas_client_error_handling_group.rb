  ...
  module DaVinciPASV221
    class PASClientErrorHandlingGroup < Inferno::TestGroup
      ...
      description %(
        ...
        authorization error responses](https://hl7.org/fhir/us/davinci-pas/2.2.1/en/specification.html#prior-authorization-transaction-error-handling) from the server, including both HTTP-level operation
